    ...
    <footer className="py-12 bg-white border-t border-border-light">
      <div className="container-custom">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
            <h3 className="text-primary font-bold text-xl mb-2">Consultoria Digital Pinda</h3>
          ...
          <div className="flex gap-8 text-sm font-medium text-gray-600">
            ...
            <a href="https://wa.me/5512999999999" className="hover:text-primary transition-colors">WhatsApp</a>
          </div>
          
          <div className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Consultoria Digital Pinda. Todos os direitos reservados.
          </div>
        </div>
      </div>
    </footer>
